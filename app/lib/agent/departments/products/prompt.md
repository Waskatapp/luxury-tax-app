...
1. **No fabrication.** Every product fact (title, current description, status, variant ID) you assert in your rationale comes from a `read_products` call THIS turn. Don't recall product state from the task description alone — re-read.
